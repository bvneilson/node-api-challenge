...
- [ ] Mention two parts of Express that you learned about this week.
  Router and server.use(json());

- [ ] Describe Middleware?
  Middleware is a group of functions that called in order. Express middleware helps create web servers and custom middleware can enhance projects.

- [ ] Describe a Resource?
  Resources are objects used by Express to map pathnames and nest resources.

- [ ] What can the API return to help clients know if a request was successful?
  A 200 status.

- [ ] How can we partition our application into sub-applications?
  Using Routers for our endpoints.
